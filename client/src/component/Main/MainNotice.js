            ...
            <div className="MainNotice">
                ...
                <div className="MainNotice-contents">
                    <div className="MainNotice-contents-box">
                        ...
                        <span className="MainNotice-contents-box-span">종이서류보다 깔끔하게 작성할 수 있어요<br/>
                    ...
                    <div className="MainNotice-contents-box">
                        <img src="/Images/level_icon.png" alt="img"/>
                        <span className="MainNotice-contents-box-title">발전의 기회</span>
                        <span className="MainNotice-contents-box-span"> 버튼 하나로 쉽게 나를 어필할 수 있어요!<br/>
                        나의 상태를 변경해보세요</span>
                    </div>
                    <div className="MainNotice-contents-box">
                        <img src="/Images/new_icon.png" alt="img"/>
