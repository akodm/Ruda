...
class Company extends Component {
    ...
    async saveStartBtn() {
        ...
        const { imgUrl,
            ...
            request,workDateState,workDate,occupation,
            question 
        } = this.state;
        try {
    ...
    render() {
        const { load,
            ...
            field,tags,since,ageAvg,rule,intro,welfare,
            request,workDateState,workDate,
            question,
            agreeCheck,
        } = this.state;
        return (
            <div className="Info-rookie-main">
                ...
                <div className="Info-rookie-body">
                    ...
                    <div className="Info-rookie-dateLayout">
                        <SelectBox 
                            ...
                            label={"근무희망 날짜"} option={["상시","졸업 후","직접입력","미정"]} text={"근무희망 날짜"} style={{marginRight:"20px"}}
                        />
                        {
                            workDateState === "직접입력" &&
                ...
                <div className="Info-rookie-agree">
                    ...
                    <span>하이루키는 신입 구직자만을 위한 서비스입니다. <span style={{color:"red"}}>기업</span>으로서 이용하심에 동의하십니까?</span>
                </div>
