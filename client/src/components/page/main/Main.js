                ...
                <div className="Main-new-bottom">
                    <div className="bottom-box" style={{backgroundColor:"#cae4ffe1"}}>
                        ...
                        <div className="bottom-box-img">
                            <img src="/Images/oauth.png" alt="img"/>
                        </div>
                    </div>
                    <div className="bottom-box-r" >
                        ...
                        <div className="bottom-box-img">
                            <img src="/Images/mypage.png" alt="img"/>
                        </div>
                    </div>
                    <div className="bottom-box" style={{backgroundColor:"#ccccffd5"}}>
                        <div className="bottom-box-content">
                            ...
                            <button className="start"onClick={this.start.bind(this)}>하이루키 시작하기</button>
                        </div>
                        <div className="bottom-box-img">
                            <img src="/Images/board.png" alt="img"/>
                        </div>
                    </div>
                </div>
            </div>
