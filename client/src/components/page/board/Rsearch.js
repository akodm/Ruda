                    ...
                    <div className="Company-search-div">
                        ...
                        <div className="Company-search-box-layout">
                            ...
                            <div className="Company-search-tag-box">
                                <AutoCreateBox size="small" margin={"5px"} value={address} blur={true} width={"100%"} text={"주소 입력"} list={[]} clear={true} onChange={(e) => this.setState({ filters : filters.concat({ row : "userAdd", data : e }) })} />
                                <AutoCreateBox size="small" margin={"5px"} value={field} blur={true} width={"100%"} text={"희망 분야"} list={dataList.app.fieldList} clear={true} onChange={(e) => this.setState({ filters : filters.concat({ row : "userField", data : e }) })} />
                                <AutoCreateBox size="small" margin={"5px"} value={tag} blur={true} width={"100%"} text={"태그 입력"} list={dataList.app.tagList} clear={true} onChange={(e) => this.setState({ filters : filters.concat({ row : "userTags", data : e }) })} />
                            </div>
                        </div>
