...
class Easy extends Component {
    ...
    async componentDidMount() {
        alert("현재 도메인이 없어 소셜 로그인이 지원되지 않습니다. 사이트 내 회원가입을 이용해주세요.");
        return;
        // try {
            ...
            <div className="easy-main">
                <div className="easy-div">
                    ...
                    <div className="easy-oauthDiv">
                        <div className="easy-btn" onClick={() => alert("현재는 도메인이 없어 지원되지 않습니다.")} ><img alt="img" src="/Images/btn_google_signin_light_normal_web.png" className="oauth-img" /></div>
                        <div className="easy-btn" onClick={() => alert("현재는 도메인이 없어 지원되지 않습니다.")} ><img alt="img"  src="/Images/facelogin.png" width="185px" height="40px" className="oauth-img"/></div>
                        <div className="easy-btn" onClick={() => alert("현재는 도메인이 없어 지원되지 않습니다.")} ><img alt="img"  src="/Images/naverlogin.png" className="oauth-img" /></div>
                    </div>
